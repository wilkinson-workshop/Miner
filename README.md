...
| `jars_cfg_fmt`    | mc: `Minecraft`<br>jar: `JarFile`<br>jcr: `JarConfResponse` | Returns a config response where all keyword are replaced with their corresponding value.                                                                                                                                                                                                               | Formated `JarConfResponse`.
